  ...
  public String askPatientQuestion(Patient patient, String question) {
    String prompt =
        GsonUtils.GSON.toJson(
            ...
            + "以上是一个json对象数组，记录了一个医生和一个病人的对话，每一个对象的q属性代表一个问题，a属性代表一个回复。接下来我会作为医生提一个问题，请你作为病人考虑从json对象数组中选择一个与我提的问题最为相似的问题并返回a属性，回答内容不要包含问题本身，回答末尾不要自行添加标点符号。如果没有任何相似的问题，请回答“请询问病情相关信息”。\n"
            + "问："
            + question;
